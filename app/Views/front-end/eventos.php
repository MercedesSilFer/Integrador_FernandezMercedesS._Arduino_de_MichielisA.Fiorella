...
<div class="container text-center">
  ...
  <div class="row align-items-center mt-5 mb-5 pt-3 pb-3 justify-content-evenly">
    ...
    <img src="<?php echo base_url('assets/img/corrientesdisena.jpg');?>" alt="" style="width:100%" class="img-fluid">
    </div>
    <div class="col-12 col-lg-3 col-md-5 mt-2">
      <p>Kurundú va a estar presente junto a estos excelentes diseñadores.</p>
    </div>
  ...
  <div class="col-12 col-lg-3 col-md-12">
    ...
    <div class="col-12 col-lg-3 col-md-7 ">
    <img src="<?php echo base_url('assets/img/feria2018.jpg');?>" alt="" style="width:100%" class="img-fluid">
    </div>
    <div class="col col-12 col-lg-3 col-md-5 mt-2">
      <p>Queremos contarles con gran alegría que vamos a participar junto a otros expositores Correntinos de la Feria Puro Diseño 2018. Estamos muy contentos por esta gran oportunidad de poder mostrar al país nuestros productos.</p>
    </div>
