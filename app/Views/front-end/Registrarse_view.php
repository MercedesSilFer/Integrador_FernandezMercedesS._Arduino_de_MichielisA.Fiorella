                 ...
                 <label for="nombreApellido"class="">
                  ...
                  <br>
                      ...
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="checkDefault" required>
                          Acepto los <a class="a-parrafos" href="<?php echo base_url('terminosYcondiciones'); ?>"> términos y condiciones de uso</a>
                        </label>
                      </div>
