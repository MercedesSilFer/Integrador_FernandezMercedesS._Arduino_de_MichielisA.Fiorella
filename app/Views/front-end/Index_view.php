        ...
        <div class="row">
            ...
            <div class="col">
                <div class="card rounded-4">
                    <img class="rounded-top-4" src="<?php echo base_url('assets/img/rinonerametal.jpg');?>" alt="" style="width:100%">
                    <br>
            ...
            <div class="col">
                <div  class="card rounded-4">
                    <img class="rounded-top-4" src="<?php echo base_url('assets/img/riñoneramarronchocolate.jpg');?>" alt="" style="width:100%">
                    <br>
                    <p><button>Agregar al carrito</button></p>
                </div>
            </div>
            <div class="col">
                <div class="card rounded-4">
                    <img class="rounded-top-4" src="<?php echo base_url('assets/img/mochilanatural.jpg');?>" alt="" style="width:100%">
                    <br>
                    <p><button>Agregar al carrito</button></p>
                </div>
            </div>
