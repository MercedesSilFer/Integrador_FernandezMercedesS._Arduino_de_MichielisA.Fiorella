...
<div class="container-fluid mt-3"> 
    ...
    <div class="row align-items-center justify-content-center">
            <h2 class="border-bottom mt-5 pt-2">Novedades</h2>
                <div class="col-md-4">
                    <div class="card rounded-4">
                        <img class="rounded-top-4 img-fluid" src="<?php echo base_url('assets/img/rinonerametal.jpg');?>" alt="" style="width:100%">
                        <br>
                ...
                <div class="col-md-4">
                    <div  class="card rounded-4">
                        <img class="rounded-top-4 img-fluid" src="<?php echo base_url('assets/img/riñoneramarronchocolate.jpg');?>" alt="" style="width:100%">
                        <br>
                        <p><button>Agregar al carrito</button></p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card rounded-4">
                        <img class="rounded-top-4 img-fluid" src="<?php echo base_url('assets/img/mochilanatural.jpg');?>" alt="" style="width:100%">
                        <br>
                        <p><button>Agregar al carrito</button></p>
                    </div>
                </div>
                <div class="col-12"><a class="text-center nav-link col-4 mx-auto" href="<?php echo base_url('catalogo'); ?>">Ver más productos</a></div>
    </div>
</div>
...
<div class="container-fluid text-center mt-3 mb-5 pt-5 pb-5">
  ...
  <hr class="bg-light opacity-25 my-1">
    <div class="container-fluid text-center tarjetas mt-3 mb-3 pt-3 pb-3 justify-content-center">
        <div class="row align-items-center">
