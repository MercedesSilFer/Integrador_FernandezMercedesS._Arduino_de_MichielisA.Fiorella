        ...
        <div class="col-lg-8 col-md-10">
            <div class="section-form w-100 align-items-center h-auto p-3 shadow-none rounded">
                ...
                <div class="text-center mb-2">
                    ...
                    <h4 class="title mb-2"><?= session('nombre_sesion'); ?>, aquí puedes ver y editar tu perfil.</h3>
                </div>
                ...
                <div class="w-75 text-center">
                    <?= form_open('actualizarPerfil', ['method' => 'post', 'class' => 'needs-validation text-start', 'novalidate' => '']); ?>
                        <div class="mb-4 text">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4 pt-3">
                            <button type="button" class="btn standard-button-outline rounded-2" data-bs-toggle="modal" data-bs-target="#passwordModal">
                                Cambiar contraseña
                            </button>
                            
                            <button type="submit" class="btn standard-button rounded-2 px-4 py-2">
                                Actualizar Perfil
                            </button>
                        </div>
                    <?= form_close(); ?>
                ...
                <?= form_open('actualizarPerfil', ['id' => 'passwordForm']); ?>
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="password" class="input-styles" name="currentPassword" id="currentPassword" required>
                            <?php if (isset($validation) && $validation->hasError('currentPassword')): ?>
                                <div class="text-danger"><?= $validation->getError('currentPassword') ?></div>
                            <?php endif; ?>
                        </div>
                        <div class="mb-3">
                            <label for="newPassword" class="mb-2">Nueva contraseña</label>
                            <input type="password" class="input-styles" name="newPassword" id="newPassword" required>
                            <?php if (isset($validation) && $validation->hasError('newPassword')): ?>
                                <div class="text-danger"><?= $validation->getError('newPassword') ?></div>
                            <?php endif; ?>
                        </div>
                        <div class="mb-3">
                            <label for="confirmPassword" class="mb-2">Confirmar nueva contraseña</label>
                            <input type="password" class="input-styles" name="confirmPassword" id="confirmPassword" required>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="standard-button">Guardar cambios</button>
                    </div>
                <?= form_close(); ?>
            </div>
        </div>
